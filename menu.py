...
def main1():
    ...
    labyrinth = Labyrint('secondLevel.tmx', [849, 850, 725], 725)
    ...
    while running:
        ...
        if game.check_win():
            game_over = True
            show_message2(screen, 'Ты выиграл)')

        if game.check_lose():
            game_over = True
            show_message2(screen, 'Ты проиграл(')
        pygame.display.flip()
        clock.tick(FPS)
    pygame.quit()
class Labyrint2:
...
def show_message2(screen, message):
    global b
    font = pygame.font.Font(None, 50)
    text = font.render(message, True, (27, 9, 71))
    text_x = WINDOW_WIDTH // 2 - text.get_width() // 2
...
def main2():
    ...
    labyrinth2 = Labyrint2('1.tmx', [306, 114], 114)
    hero2 = Hero2('princieska.png', (3, 10))
    enemy2 = Enemy2('pirat.png', (14, 5))
    game2 = Game2(labyrinth2, hero2, enemy2)
    ...
    while running:
        ...
        screen2.fill((0, 0, 0))
        game2.render(screen2)
        if game2.check_win():
            game_over = True
            show_message2(screen2, 'Ты выиграл)')
        if game2.check_lose():
            game_over = True
            show_message2(screen2, 'Ты проиграл(')
